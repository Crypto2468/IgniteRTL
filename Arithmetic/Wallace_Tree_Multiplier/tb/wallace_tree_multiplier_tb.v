...
// File Name:    wallace_tree_multiplier_tb.v
// Description:  Exhaustive self-checking testbench for the 4x4 Wallace Tree 
//               Multiplier. Verifies all 256 input combinations.
//
...
module wallace_tree_multiplier_tb;
    ...
    wallace_tree_multiplier u_wallace (
        .a       (tb_a),
        .b       (tb_b),
        .product (tb_product)
    );

...
// File Name:    restoring_divider_tb.v
// Description:  Self-checking testbench for the sequential Restoring Divider.
...
module restoring_divider_tb;
    ...
    initial begin
        ...
        $display("==================================================");
        $display("Starting Restoring Divider Testbench Simulation");
        $display("==================================================");
        ...
        run_division(8'd50, 8'd0);

        // Test Case 2: Dividend smaller than divisor
        run_division(8'd5, 8'd10);

        // Test Case 3: Exact division
        run_division(8'd100, 8'd10);

        // Test Case 4: Non-exact division
        run_division(8'd100, 8'd3);

        // Test Case 5: Max limits
        run_division(8'hFF, 8'd2);

        // Test Case 6: Random Cases
        for (i = 0; i < 15; i = i + 1) begin
            // Avoid division by zero to check math accuracy
